...
title = "ADR-0016: Memory-First Secrets Store"
weight = 10016
sort_by = "weight"
+++
...
- Status:
  - Superseded by
    [ADR-0024: Transition from In-Memory Cache to Direct Backend Storage for
     High Availabilitye](@/architecture/adrs/adr-0024.md)
- Date: 2025-08-23
- History:
  - 2024-12-22: Accepted
...
* *Security and Persistence*: Using an encrypted database as the source of truth
  ...
  minimized and can further be mitigated by using mechanisms like message
  queues.
