...
- Status:
    - Superseded by
      [ADR-0020: Switch to Zola for Documentation
       System](@/architecture/adrs/adr-0020.md)
- Date: 2025-02-20
- History:
    - 2024-11-03: Accepted
...
* Markdown support: Developers can write documentation in familiar Markdown
  syntax
...
* Documentation loading might be slightly slower compared to pre-built static
  sites
